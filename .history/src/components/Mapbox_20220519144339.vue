<template>
  ...
  <div id="map" class="relative h-[calc(100vh-57px)] w-full md:h-screen">
    <div
      id="float"
      class="absolute bottom-0 h-fit w-full rounded-t-xl bg-primary p-3 text-white md:top-10 md:left-14 md:w-[452px] md:rounded-xl"
    >
      <div class="flex">
      ...
      <div
        class="mt-3 flex items-center justify-between border-b border-secondary-dark pb-2"
      >
        <span>附近站點</span>
        <div class="space-x-2">
          ...
          <div class="flex">
            ...
            <div class="flex flex-col">
              ...
              <div class="flex items-center justify-between">
                <span class="text-">正常營運</span>
                <span>YouBike1.0｜總數：30 </span>
              </div>
            </div>
          </div>
          <span>地址：忠孝東路/松仁路(東南側)</span>
        </div>
        <div class="flex flex-col">
          <div class="flex rounded-xl bg-primary-light">
            <span class="">20</span>可選
          </div>
          <div class="flex rounded-xl bg-primary-light"></div>
        </div>
      </div>
    </div>
  </div>
