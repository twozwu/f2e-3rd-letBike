<template>
  <div class="mb-[57px] h-screen md:relative">
    <div
      id="float"
      class="absolute bottom-0 z-10 h-fit w-full rounded-t-xl bg-primary-light p-3 text-white md:top-10 md:left-14 md:w-[452px] md:rounded-xl"
    >
      <div class="flex">
